...
\newcommand{\contact}
{
    ...
    \textcolor{white}
    {
        \faEnvelope \quad \href{mailto:xxxx@mail.nwpu.edu.cn}{xxxx@njupt.edu.cn}    % 邮箱，前面的超链接可以直达邮箱软件
        \hspace{6em}    % 这里可以调间距
...
\begin{document}
    ...
    \begin{table}[h!]
         \begin{tabularx}{\textwidth}{XXp{\widthof{2021年 -- 2025年}}}
            南京邮电大学-自动化学院 & 控制科学与工程 & 2021年 -- 2025年\\
            \textbf{GPA:3.6/5.0}  &主修课程：11111111111111111111111111111111111111111111\\
        \end{tabularx}
   ...
   \begin{tikzpicture}[remember picture, overlay]
    ...
    \section{\makebox[\widthof{\faTrophy}][c]{\color{Blue}{\faTrophy}}\quad 竞赛经历}
    \vspace{-1em}
    \begin{table}[h!]
    ...
    % 所获荣誉（这个看你想不想写了）
    \section{\makebox[\widthof{\faStar}][c]{\color{Blue}{\faStar}}\quad 所获荣誉}
    \vspace{-1em}
    \begin{multicols}{2}
        \begin{itemize}
            \item 某年学业先进个人
