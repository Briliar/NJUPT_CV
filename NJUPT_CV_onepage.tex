...
\setlist[itemize]{topsep=0em,parsep=0em, leftmargin=*}		
\setlist[enumerate]{topsep=0em,parsep=0em, leftmargin=*}	
...
\begin{document}
    ...
    \begin{figure}[h]
        ...
        \begin{minipage}{0.87\textwidth}
            \section{\makebox[1em][c]{\color{Blue}{\faUser}}\hspace{0.5em}个人信息}
    ...
    % --- 教育背景 ---
    \vspace{-2em}
	\section{\makebox[1em][c]{\color{Blue}{\faGraduationCap}}\hspace{0.5em}教育背景}
	\vspace{-1em}
    \begin{table}[h!]
    ...
    % \faUsers 这是三个人，适合商科
    \vspace{-1em}
    \section{\makebox[1em][c]{\color{Blue}{\faWrench}}\hspace{0.5em}技能特长}
    \vspace{0.5em}
    \begin{itemize}
    ...
    \section{\makebox[1em][c]{\color{Blue}{\faGears}}\hspace{0.5em}项目经历}
    \vspace{0.5em}
    ...
    % --- 竞赛经历 ---
    \section{\makebox[1em][c]{\color{Blue}{\faTrophy}}\hspace{0.5em}竞赛/科研经历}
    \vspace{-1em}
    \begin{table}[h!]
    ...
    \vspace{-1em}
    % --- 其他 ---
    \section{\makebox[1em][c]{\color{Blue}{\faInfo}}\hspace{0.5em}其他}
    \begin{itemize}
